(function () {
    ...
    Lampa.SettingsApi.addParam({
        component: "tfilter_tweaks",
        param: {
            name: "apx_colorBorder",
            type: "trigger",
            "default": false
        },
        field: {
            name: "Color borders",
            description: "Enable color borders around the buttons"
        },
    ...
    Lampa.SettingsApi.addParam({
        ...
        field: {
            name: "Rebind 'right'",
            description: "Rebind 'right' to trigger longpress action instead of filter"
        },
        onChange: function onChange(value) {
            Lampa.Settings.update();
        }
    ...
    Lampa.SettingsApi.addParam({
        ...
        param: {
            ...
            type: "select",
            "default": "home",
            values: { home: "Go to home page", component: "Select video plugin" }
        },
        field: {
            name: "Custom button",
            description: "Behaviour of first button"
        },
        onChange: function onChange(value) {
            Lampa.Settings.update();
...
`
    ...
    if (Lampa.Storage.get('apx_colorBorder', {}) == true) cssRules = cssRules + cssRulesColor
    ...
    var plugTvKeys = {
		...
		_customButton_comp: function(e) {
 		...
 		_customButton_home: function(e) {
			var tfilter = document.querySelector('.torrent-filter');
                if (tfilter !== null) {
                    tfilter.children[tfilter.children.length - 4].on('hover:enter', function() {Lampa.Activity.last()});
            }
        },
        ...
        start: function () {
            document.addEventListener('keyup', this._listenTvKeys);
			Lampa.Controller.listener.follow('toggle', Lampa.Storage.get('apx_customButton', {}) == 'component'?this._customButton_comp.bind(this):this._customButton_home);
